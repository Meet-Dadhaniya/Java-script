...
//"33abc"(number and letter combation in string) it will not convert in number datatype it will give Null as output.
...
//as per the upper ex we can conert number to string 
